...
export const AboutPage = () => {
    ...
    const writenText = [
      ...
      {
        img: "https://images.pexels.com/photos/415263/pexels-photo-415263.jpeg?auto=compress&cs=tinysrgb&w=600",
    ...
    return (
        ...
        <div className="h-[90vh] relative justify-center w-full bg-black ">
          <img src="https://images.pexels.com/photos/9561302/pexels-photo-9561302.jpeg?auto=compress&cs=tinysrgb&w=600" className="absolute top-0 right-0 object-cover w-full h-full z-0" alt="About us image" />

          <p className="text-white font-bold absolute bottom-10 left-5 text-2xl">ABOUT  HAUTESIDE</p>
        </div>
        ...
        <div className="w-full grid gap-2 md:gap-4 grid-cols-2 md:grid-cols-4 px-2 h-auto  md:px-20 mx-auto bg-gray-200/35">
          {subimage.map((el) => (
          ...
          <div className=" max-w-[800px]   mx-auto">
            ...
            {writenText.map((el) => (
              <div className="flex flex-col items-center justify-center  md:flex-row gap-5 px-2   my-4  w-full ">
                ...
                <div className="flex w-full items-center md:items-start justify-center flex-col px-2 sm:px-10 gap-3 ">
                  <p className="font-bold text-black items-center text-base">{el.testimoni}</p>
                  <p className="text-sm font-semibold">{el.user}</p>
                </div>
              </div>
            ))}
          </div>
